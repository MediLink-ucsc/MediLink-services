...
const publicRoutes = ['/', '/health',
  ...
  '/api/v1/patientRecords/visitedpatients',
  '/api/v1/patientRecords/patientlist',
  '/api/v1/patientRecords/careplans/:patientId',
  '/api/v1/patientRecords/nurse/prescriptions',
